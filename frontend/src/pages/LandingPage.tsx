...
import AppleLogo from "../assets/apple1.svg";
...
const FEATURES = [
  ...
  },
  {
    ...
    desc: "All companies are vetted to ensure authentic job listings.",
  },
  {
    icon: Globe,
    title: "Remote Friendly",
    desc: "Find remote, hybrid, or on-site roles from top companies worldwide.",
  },
];
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary-500/20 border border-primary-500/30 text-primary-300 text-sm font-medium mb-6">
              <Star className="w-3.5 h-3.5" /> #1 Job Portal for Tech
              Professionals
            </span>
            <h1 className="text-5xl md:text-7xl font-extrabold text-white leading-tight mb-6">
              Find Your
              <span className="block bg-gradient-to-r from-primary-400 to-blue-300 bg-clip-text text-transparent">
                Dream Career
              </span>
            </h1>
            <p className="text-xl text-slate-300 max-w-2xl mx-auto mb-10">
              Connect with top companies and unlock opportunities that match
            ...
            <div className="flex flex-col sm:flex-row gap-3 p-2 bg-white dark:bg-dark-card rounded-2xl shadow-2xl">
              <div className="flex-1 flex items-center gap-2 px-4">
                ...
                <input
                  ...
                  className="flex-1 text-slate-900 dark:text-white bg-transparent outline-none placeholder-slate-400 text-sm"
                />
              </div>
              <div className="hidden sm:flex items-center gap-2 px-4 border-l border-slate-200 dark:border-dark-border">
                ...
                <input
                  ...
                  className="w-36 text-slate-900 dark:text-white bg-transparent outline-none placeholder-slate-400 text-sm"
                />
              </div>
          ...
          >
            ...
            {[
              ...
              <button
                ...
                className="text-primary-400 hover:text-primary-300 transition-colors mx-1"
              >
                {term}
              </button>
            ))}
      ...
      {/* Companies */}
      <section className="relative overflow-hidden py-20 bg-slate-100 dark:bg-dark-card/50">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-slate-500 text-lg max-w-2xl mx-auto">
              Join thousands of professionals working at industry-leading
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {FEATURES.map((f, i) => (
            ...
            >
              ...
              <p className="text-sm text-slate-500 dark:text-dark-text leading-relaxed">
                {f.desc}
              </p>
            </motion.div>
          ))}
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        <div className="relative overflow-hidden bg-gradient-to-r from-primary-600 to-blue-600 rounded-3xl p-10 md:p-16 text-center text-white">
          ...
          <p className="text-primary-100 text-lg mb-8 max-w-xl mx-auto">
            Join over 1 million professionals who found their dream job on
            JobHub.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/register"
              className="px-8 py-3 bg-white text-primary-600 font-semibold rounded-xl hover:bg-primary-50 transition-colors shadow-lg"
            >
              Get Started Free
            </Link>
            <Link
              to="/jobs"
              className="px-8 py-3 bg-white/20 border border-white/40 text-white font-semibold rounded-xl hover:bg-white/30 transition-colors"
            >
              Browse Jobs
            </Link>
          </div>
